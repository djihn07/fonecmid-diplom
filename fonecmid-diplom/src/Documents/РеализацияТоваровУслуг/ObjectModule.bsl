...
#Если Сервер Или ТолстыйКлиентОбычноеПриложение Или ВнешнееСоединение Тогда
	...
	Процедура ОбработкаЗаполнения(ДанныеЗаполнения, ТекстЗаполнения, СтандартнаяОбработка)
		...
		// Заполнение реквизитов из выборки запроса
	...
	Процедура СоздатьДвиженичBKM_ВыполненныеРаботыКлиенту(Отказ)
		...
		// Предварительно вычислем ЧасыКОплате и проводим по старой методике.
	...
	Процедура BKM_ВыполнитьАвтозаполнение() Экспорт
		...
		// Выборка данных по абонентской оплате и работе специалиста, учтено состояние проведения (проведено, непроведено) документа
		Запрос = Новый Запрос;
		Запрос.Текст = 
		"ВЫБРАТЬ
