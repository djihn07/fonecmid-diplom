...
#### Настройки и условия для успешного прохождения тестов.
    ...
    3. Автотестирование должно проходить в строгой последовательности, так как некоторые тесты оприаются на данные созданными другими тестами.
        - 1. Запуск автотестирования из файла Создание документа Обслуживание клиента.feature
        - 2. Запуск Закрытие документа Обслуживание клиента.feature
        - 3. Запуск Массовое создание актов.feature
        - 4. И Для последнего тестирования необходимо сохранить на компьютер файлы из репоитория Июнь2026.mxl и Июль2026.mxl. 
